...
# def uniformer_small():
#     return Uniformer(
#         depth=[2, 2, 2, 2], embed_dim=[64, 128, 128, 128], num_classes=2, in_chans=64,
#         head_dim=32, drop_rate=0.0)
    
def uniformer_small():
    return Uniformer(
        depth=[3, 4, 8, 3], embed_dim=[64, 128, 320, 512], num_classes=2, in_chans=64,
        head_dim=64, drop_rate=0.1)

def uniformer_base():
    return Uniformer(
        depth=[5, 8, 20, 7], embed_dim=[64, 128, 320, 512], num_classes=2, in_chans=64,
        head_dim=64, drop_rate=0.1)
