...
finetune = True
pretrained_weight = "/Data3/cao/ZiHanCao/huawei_contest/code3/zihan/ckpts/ziqi_Resnet101/P3_ep_1_iter399.pth"
if finetune:
...
# angle_dim = 128
# range_dim = 150
factor = 200 if not finetune else 100
slice_num = 450
slice_num_r1 = 0
...
class TrainDataset(Dataset):
    def __init__(self):
        data_dir1 = r"/Data3/cao/ZiHanCao/huawei_contest/data/Round3Pos3/train_new64.h5"
        ...
        if not finetune:
            ...
            global_idx_to_local = {}
            total_len = (
                file1.shape[0] + file4.shape[0] + file5.shape[0] + file6.shape[0]
            )
            for i in range(total_len):
                if i < file1.shape[0]:
                    ...
                    global_idx_to_local[i] = (
                        3,
                        i - file1.shape[0] - file4.shape[0] - file5.shape[0],
                    )
            self.global_idx_to_local = global_idx_to_local
            data_files = [file1, file4, file5, file6]
            truth_lines = read_slice_of_file(anchor_path, 900, 1350)
            truth_lines2 = read_slice_of_file(anchor_path2, 0, 3000)
...
class TestDataset(Dataset):
    ...
    def __init__(self):
        data_dir1 = r"/Data3/cao/ZiHanCao/huawei_contest/data/Round3Pos3/test_new64.h5"
        file1 = h5py.File(data_dir1, "r")["data"][:]
        getMemInfo(logger)
        ...
        self.datalist = []
        truth_lines = read_slice_of_file(anchor_path, 100, 150)
        ...
        if not opt.eval_only:
            ...
            for batch_idx, (data, target) in enumerate(train_loader, 1):
                ...
                if (batch_idx + 1) % 100 == 0:
                    ...
                    model.eval()
                    ema_model.eval()
                    save_path = f"/Data3/cao/ZiHanCao/huawei_contest/code3/zihan/ckpts/finetuneTransformer3dP3/ep_{epoch}_iter{batch_idx}.pth"
                    ...
                    logger.info("model saved to {}".format(Path(save_path)))
